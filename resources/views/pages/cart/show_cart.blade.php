                  ...
                  <tr>
                    ...
                    <td>
                        <div class="cart-product">
                            {{-- <input type="hidden" value="{{ $v_content->}}" name="rowId_cart" class="form-control"> --}}
                    ...
                    <td class="cart-product--quantity">
                        <form action="{{URL::to('/update-cart-quantity/')}}" method="post">
                            {{ csrf_field() }}
                            <input type="number" class="cart_quantity_input cart_quantity" value="{{ $v_content->qty}}" min="1" name="cart_quantity">
