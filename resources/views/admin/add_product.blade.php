                    ...
                    <div class="position-center">
                        <form role="form" action="{{URL::to('/save-product')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="product_quantity" placeholder="Nhập số lượng sản phẩm..."data-validation="number" data-validation-error-msg="Vui lòng điền số lượng sản phẩm">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Hướng Dẫn Sử Dụng Sản Phẩm</label>
