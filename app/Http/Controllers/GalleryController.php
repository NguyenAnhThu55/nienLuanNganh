        ...
        if($gallery_count>0){
            ...
            foreach($gallery as $key => $gal){
                ...
                <tr>
                    ...
                    <td><img src="'.url('public/uploads/gallery/'.$gal->gallery_image).'" class="img-thumnail" style="width:100px;heght:100px"></td>    
                    <td>
                    <button type="button" data-gal_id="'.$gal->gallery_id.'" 
                        class="btn btn-xs btn-danger delete-gallery">Xóa
                    </button>
                    </td>
                </tr>
