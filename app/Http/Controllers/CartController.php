...
class CartController extends Controller
{
    ...
    public function show_cart_quantity(Request $request){
        $cart = 0;
        ...
        <div class="header-cart">
            <a href="'.url('/show-cart').'"aria-expanded="true">
                <i class="fas fa-shopping-cart" style="width: 40px;
                height: 40px;
                color: black;
                text-align: center;
                font-size: 28px;" alt="cart" srcset="" title="Giỏ Hàng"></i>
